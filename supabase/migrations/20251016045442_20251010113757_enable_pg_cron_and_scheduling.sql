...
BEGIN
  ...
  IF supabase_url IS NULL THEN
    supabase_url := 'https://gzmwcbbllurnqlzpsafz.supabase.co';
  END IF;

  -- Get anon key from environment
  anon_key := current_setting('app.settings.supabase_anon_key', true);
  IF anon_key IS NULL THEN
    anon_key := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd6bXdjYmJsbHVybnFsenBzYWZ6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA1ODYyNTcsImV4cCI6MjA3NjE2MjI1N30.eAnoEmFO0QZgw5_sByI0GgQVEHe7s6fwtdMDkbj4WIg';
  END IF;
